    ...
    try:
        while True:
            ...
            if data0 is not None:
                ...
                cv2.putText(img_with_data, f'Sensor 0: {data_old0}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)

            if data1 is not None:
                cv2.putText(img_with_data, f'Sensor 1: {data1}', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                data_old1 = data1
            else:
                cv2.putText(img_with_data, f'Sensor 1: {data_old1}', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

            if data2 is not None:
                cv2.putText(img_with_data, f'Sensor 2: {data2}', (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                data_old2 = data2
            else:
                cv2.putText(img_with_data, f'Sensor 2: {data_old2}', (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
